...
/* harmony import */ var _modules_choose_membership__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/choose-membership */ "./js/modules/choose-membership.js");
...
/* harmony import */ var _modules_valid_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/valid-form */ "./js/modules/valid-form.js");
/* harmony import */ var _modules_trainers_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/trainers-swiper */ "./js/modules/trainers-swiper.js");
/* harmony import */ var _modules_reviews_swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/reviews-swiper */ "./js/modules/reviews-swiper.js");
...
Object(_modules_trainers_swiper__WEBPACK_IMPORTED_MODULE_4__["trainersSwiper"])();
Object(_modules_reviews_swiper__WEBPACK_IMPORTED_MODULE_5__["reviewsSwiper"])();
Object(_modules_play_video__WEBPACK_IMPORTED_MODULE_2__["playVideo"])();
Object(_modules_choose_membership__WEBPACK_IMPORTED_MODULE_1__["chooseMembership"])();
Object(_modules_valid_form__WEBPACK_IMPORTED_MODULE_3__["validForm"])(); // ---------------------------------
...
/***/ "./js/modules/choose-membership.js":
/*!*****************************************!*\
  !*** ./js/modules/choose-membership.js ***!
  \*****************************************/
/*! exports provided: chooseMembership */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chooseMembership", function() { return chooseMembership; });
var membership = document.querySelector('.membership');
var membershipButtonsContainer = membership.querySelector('.membership__period-list');
var membershipPeriodList = membership.querySelectorAll('.membership__period-button');
var membershipOptionList = membership.querySelectorAll('.membership__option-list');

function hideAll() {
  for (var i = 0; i < membershipPeriodList.length; i++) {
    membershipPeriodList[i].classList.remove('membership__period-button--active');
  }

  for (var _i = 0; _i < membershipOptionList.length; _i++) {
    membershipOptionList[_i].classList.add('membership__option-list--disable');
  }
}

var chooseMembership = function chooseMembership() {
  membershipButtonsContainer.addEventListener('click', function (evt) {
    ...
    if (evt.target.classList.contains('membership__period-button--active')) {
      ...
      var numb = evt.target.getAttribute('data-num');
...
var videoLink = video.querySelector('.gym__video a');
var videoButton = video.querySelector('.gym__video-button');
var videoMedia = video.querySelector('.gym__video img');
var videoIframe = video.querySelector('.gym__video-iframe');
...
var reviewsSwiper = function reviewsSwiper() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews', {
...
var trainersSwiper = function trainersSwiper() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainers__list-wrapper', {
...
/***/ "./js/modules/valid-form.js":
/*!**********************************!*\
  !*** ./js/modules/valid-form.js ***!
  \**********************************/
/*! exports provided: validForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var myInput = document.getElementById('input-phone');
...
var validForm = function validForm() {
  document.addEventListener('DOMContentLoaded', function () {
    Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(myInput, maskOptions);
  }); // const PHONE_LENGTH = 11;

  var userInput = document.getElementById('input-phone');
  var submitButton = document.getElementById('free-button');
  submitButton.addEventListener('click', function () {
    var a = userInput.value.length;
